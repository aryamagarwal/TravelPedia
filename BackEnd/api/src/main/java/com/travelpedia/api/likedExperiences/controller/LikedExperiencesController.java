...
@RequestMapping("/permit/likedExperiences")
public class LikedExperiencesController {
    ...
    public List<LikedExperiencesModel> getLikedExperienceByUser(@PathVariable("userId") Long userId) {
        return les.getLikedExperienceByUser(userId);
    }
